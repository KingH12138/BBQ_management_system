package com.hqyj.bbq.demo.generator;
...
/*    public static String scanner(String tip) {
    ...
    public static void main(String[] args) {
        ...
        dsc.setPassword("20020320");
        dsc.setUrl(
                "jdbc:mysql://127.0.0.1:3306/hqyj_cn0?useUnicode=true&characterEncoding=utf8");
        mpg.setDataSource(dsc);
        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setModuleName("user");// 模块名
        pc.setParent("com.hqyj.bbq.demo");
        ...
        strategy.setRestControllerStyle(true);  //在controller层 增加restfull注解
